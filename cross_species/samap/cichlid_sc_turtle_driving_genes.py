...
# Read SAMap results
with open('/storage/home/hcoda1/6/ggruenhagen3/scratch/bcs/data/bb_turtle_sm_ran.pkl', 'rb') as out_file:
...
# Define clusters
keys={'mz':'good_names','cp':'cp_detail'}
...
all_pairs_df.to_csv("/storage/home/hcoda1/6/ggruenhagen3/scratch/bcs/results/bb_turtle_samap_genes.csv")
...
all_pairs_num.to_csv("/storage/home/hcoda1/6/ggruenhagen3/scratch/bcs/results/bb_turtle_samap_genes_num.csv")
