...
# Main
# Read SAMap results
with open('/storage/home/hcoda1/6/ggruenhagen3/scratch/bcs/data/bb_saunders_sm_ran_3.pkl', 'rb') as out_file:
...
real = my_mapper(mz_col = 'mz_good_names', mm_col = 'mm_tissue_subcluster')
real.to_csv("/storage/home/hcoda1/6/ggruenhagen3/scratch/bcs/results/bb_saunders_subcluster_mapping_mine4.csv")

# Permutations
perm_nums = 1000
import multiprocessing
with multiprocessing.Pool(multiprocessing.cpu_count()) as mp_pool:
    perm_list = mp_pool.starmap(perm_mapper, zip(list(range(1, perm_nums+1)), ['mz_good_names'] * perm_nums, ['mm_tissue_subcluster'] * perm_nums))
...
perm_p.to_csv("/storage/home/hcoda1/6/ggruenhagen3/scratch/bcs/results/bb_saunders_subcluster_mapping_mine_p4.csv")
