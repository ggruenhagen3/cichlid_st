...
# Protein -> Gene table
mm_prot = pd.read_csv('/storage/home/hcoda1/6/ggruenhagen3/scratch/m_zebra_ref/mouse_prot_table3.csv', sep=None)
...
fn1 = '/storage/home/hcoda1/6/ggruenhagen3/scratch/brain/data/st_c2b2.h5ad'
fn2 = '/storage/home/hcoda1/6/ggruenhagen3/scratch/bcs/data/oritz_b_clean.h5ad'
...
# Save samap
import pickle
with open('/storage/home/hcoda1/6/ggruenhagen3/scratch/bcs/data/mz_mm_st_oritiz_b_samap_3.pkl', 'wb') as out_file:
    pickle.dump(samap, out_file)


with open('/storage/home/hcoda1/6/ggruenhagen3/scratch/bcs/data/mz_mm_st_oritiz_b_sm_ran_3.pkl', 'wb') as out_file:
    pickle.dump(sm, out_file)

# Export as h5ad so it can be loaded into Seurat
samap.adata.write_h5ad("/storage/home/hcoda1/6/ggruenhagen3/scratch/bcs/data/mz_mm_st_oritiz_b_3.h5ad")
