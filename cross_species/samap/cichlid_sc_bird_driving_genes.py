...
# Define the clusters
keys={'mz':'good_names','tg':'cluster_orig2'}
...
ct1 = ['tg_' + s for s in np.sort(sm.sams['tg'].adata.obs[keys['tg']].unique()).tolist()]
...
all_pairs_df.to_csv("/storage/home/hcoda1/6/ggruenhagen3/scratch/bcs/results/bb_bird_samap_genes.csv")
...
all_pairs_num.to_csv("/storage/home/hcoda1/6/ggruenhagen3/scratch/bcs/results/bb_bird_samap_genes_num.csv")
