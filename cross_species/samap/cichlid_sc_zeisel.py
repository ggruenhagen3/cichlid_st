...
mm_prot = pd.read_csv('/storage/home/hcoda1/6/ggruenhagen3/scratch/m_zebra_ref/mouse_prot_table3_zeisel.csv', sep=None)
...
fn2 = '/storage/home/hcoda1/6/ggruenhagen3/scratch/bcs/data/zeisel_tel_norm.h5ad'
...
# Save samap
import pickle
with open('/storage/home/hcoda1/6/ggruenhagen3/scratch/bcs/data/bb_zeisel_sm_ran.pkl', 'wb') as out_file:
    pickle.dump(sm, out_file)

# Export as h5ad so it can be loaded into Seurat
samap.adata.write_h5ad("/storage/home/hcoda1/6/ggruenhagen3/scratch/bcs/data/bb_zeisel.h5ad")
